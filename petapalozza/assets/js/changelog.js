$(function () {
  ...
  var metaData = ["1.2.9", "29/06/2025"]
  updateMetaInfo(metaData)

  // Just add a new row.
  var changeLogData = [
    // Add a new row below this comment.
    ["2025, June 29 - v 1.2.9", ["Updated: WPBakery Page Builder to 8.5", "Updated: Petapalozza Theme WPBakery Page Builder Addon to 1.1.9", "Updated: WooCommerce template files."]],
